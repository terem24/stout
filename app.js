        ...
        container.innerHTML = `
            ...
            ">
                ...
                <input type="text" id="sub_name" placeholder="Имя и фамилия" value="${user.name || user.first_name || ''}" 
                    style="width: 100%; height: 55px; border: 1px solid #e5e5e5; border-radius: 10px; padding: 0; margin-bottom: 12px; font-size: 16px; text-align: center; background: #fff; box-sizing: border-box;">
                ...
                <input type="tel" id="sub_phone" placeholder="Номер телефона" value="${user.phone || ''}" 
                    style="width: 100%; height: 55px; border: 1px solid #e5e5e5; border-radius: 10px; padding: 0; margin-bottom: 25px; font-size: 16px; text-align: center; background: #fff; box-sizing: border-box;">
