...
const app = {
    ...
    showModal: function (type) {
        ...
        // Сброс состояния окна (показываем карточки, скрываем форму)
        this.showProCards();
    ...
    submitProRequest: async function (e) {
        ...
        const templateParams = {
            plan_name: formData.get('selected_plan'),
        ...
        try {
            // Используем те же ключи EmailJS, что и для сметы
            const EMAILJS_SERVICE_ID = "service_o11b4ej";
            const EMAILJS_TEMPLATE_ID = "template_lg1zol9"; // Возможно стоит использовать другой шаблон, но используем этот как базовый
