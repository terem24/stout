...
const app = {
    ...
    toggleWaterInput: function (val) {
        ...
        this.saveState();
        this.render();
        // Apply display AFTER render so it's not overridden
        let optBlock = document.getElementById('blk_water_input_opts');
        if (optBlock) optBlock.style.display = val ? 'flex' : 'none';
    },
    ...
    init: function () {
        ...
        let optBlock = document.getElementById('blk_water_input_opts');
        if (optBlock) optBlock.style.display = this.state.waterInput ? 'flex' : 'none';
        this.syncUI(); this.render();
