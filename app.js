...
const app = {
    ...
    syncUI: function () {
        ...
        if (document.getElementById('chk_scheme')) {
            document.getElementById('chk_scheme').checked = (this.state.showScheme !== false);
        }
    ...
    render: function () {
        ...
        if (this.state.viewMode === 'equipment' && this.state.showScheme !== false) {
