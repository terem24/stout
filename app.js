...
const app = {
    ...
    animateNumber: function(obj, start, end, duration) {
        ...
        const step = (timestamp) => {
            ...
            // Плавное и сильное замедление к концу анимации (ease-out quintic)
    ...
    render: function () {
        ...
        if (headerTotals) {
            ...
            if (oldEq !== newEq && elEq) {
                app.animateNumber(elEq, oldEq, newEq, 1200); // Замедлено в 2 раза (1200мс)
            ...
            if (isPro) {
                ...
                if (oldWorks !== newWorks && elWorks) {
                    app.animateNumber(elWorks, oldWorks, newWorks, 1200); // Замедлено в 2 раза
...
window.addEventListener('beforeprint', function () {
    ...
    if (printArea) {
        ...
        let isPro = app.state.accountType === 'pro';
        if (isPro) {
