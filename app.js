...
const titanRads = [
    { id: "STT-0001-000504", name: "Радиатор Titan 4 секц.", article: "STT-0001-000504", sec: 4, power50: 512, price: 4324, brand: "STOUT" },
    { id: "STT-0001-000506", name: "Радиатор Titan 6 секц.", article: "STT-0001-000506", sec: 6, power50: 768, price: 6486, brand: "STOUT" },
    { id: "STT-0001-000508", name: "Радиатор Titan 8 секц.", article: "STT-0001-000508", sec: 8, power50: 1024, price: 8648, brand: "STOUT" },
    { id: "STT-0001-000510", name: "Радиатор Titan 10 секц.", article: "STT-0001-000510", sec: 10, power50: 1280, price: 10810, brand: "STOUT" },
    { id: "STT-0001-000512", name: "Радиатор Titan 12 секц.", article: "STT-0001-000512", sec: 12, power50: 1536, price: 12972, brand: "STOUT" },
    { id: "STT-0001-000514", name: "Радиатор Titan 14 секц.", article: "STT-0001-000514", sec: 14, power50: 1792, price: 15134, brand: "STOUT" }
];

const steelRads = [
    { id: "SFP-2203-050040", name: "Рад. панельный 22-500-400", article: "SFP-2203-050040", power50: 540, sec: 400, price: 4434, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050050", name: "Рад. панельный 22-500-500", article: "SFP-2203-050050", power50: 675, sec: 500, price: 4945, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050060", name: "Рад. панельный 22-500-600", article: "SFP-2203-050060", power50: 810, sec: 600, price: 5456, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050070", name: "Рад. панельный 22-500-700", article: "SFP-2203-050070", power50: 945, sec: 700, price: 5967, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050080", name: "Рад. панельный 22-500-800", article: "SFP-2203-050080", power50: 1080, sec: 800, price: 6478, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050090", name: "Рад. панельный 22-500-900", article: "SFP-2203-050090", power50: 1215, sec: 900, price: 6989, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050100", name: "Рад. панельный 22-500-1000", article: "SFP-2203-050100", power50: 1350, sec: 1000, price: 7499, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050110", name: "Рад. панельный 22-500-1100", article: "SFP-2203-050110", power50: 1485, sec: 1100, price: 8011, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050120", name: "Рад. панельный 22-500-1200", article: "SFP-2203-050120", power50: 1620, sec: 1200, price: 8522, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050140", name: "Рад. панельный 22-500-1400", article: "SFP-2203-050140", power50: 1890, sec: 1400, price: 9543, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050160", name: "Рад. панельный 22-500-1600", article: "SFP-2203-050160", power50: 2160, sec: 1600, price: 10565, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050180", name: "Рад. панельный 22-500-1800", article: "SFP-2203-050180", power50: 2430, sec: 1800, price: 11586, brand: "STOUT", isPanel: true },
    { id: "SFP-2203-050200", name: "Рад. панельный 22-500-2000", article: "SFP-2203-050200", power50: 2700, sec: 2000, price: 12608, brand: "STOUT", isPanel: true }
];
...
const REGION_DESC = {
    130: "Сибирь (Тор до -35°C)",
    120: "Урал (Тор до -30°C)",
    100: "Центр (Тор до -25°C)",
    60: "Юг (Тор до -15°C)"
};

const WALL_DESC = {
    1.3: "🧱 Тонкие стены (Кирпич 250мм / Брус 150мм)",
    1.0: "🏠 Стены ГОСТ (Газоблок 400мм / Кирпич + Утепл.)",
    0.8: "🌳 Теплый дом (Энергоэффективные стены 500мм+)"
};
...
function getProductIcon(id) {
    ...
    const icons = {
        "SGB": "🔥", "SEB": "⚡", "SWH": "💧", "SRB": "🌡️", "STT": "🛡️", "SFP": "◽",
        "STH": "🎈", "STW": "🎈", "SPX": "🧪", "SPI": "🧪", "SPI": "🧪", "SMS": "📊",
        "SMB": "📉", "SSC": "📦", "SFT": "🔧", "SVP": "🔧", "SND": "📏", "SDG": "🌿",
        "SPC": "🔄", "SIR": "🔌", "SCS": "🔌", "SVH": "🔗", "SHT": "⚙️", "SFT": "🔩",
        "SCQ": "🌀", "SCN": "🌀", "RAD": "➕"
    };
    return icons[prefix] || "📦";
}
...
function getImg(item) {
    ...
    let icon = getProductIcon(id);
    let colorClass = "bg-primary";
    if (id.startsWith('SGB')) colorClass = "bg-orange";
    if (id.startsWith('SEB')) colorClass = "bg-yellow";
    if (id.startsWith('SWH')) colorClass = "bg-blue";

    return `<div class="product-avatar ${colorClass}">${icon}</div>`;
}
    ...
    init: function () {
        ...
        let radAlts = [catalog.rads[0], catalog.rads_plus[0], titanRads[0], steelRads[0]];
        catalog.rads.forEach(rad => { rad.alts = radAlts; });
        catalog.rads_plus.forEach(rad => { rad.alts = radAlts; });
        titanRads.forEach(rad => { rad.alts = radAlts; }); steelRads.forEach(rad => { rad.alts = radAlts; });
    ...
    cycleSwap: function (originalId) {
        let isRad = (catalog.rads.find(x => x.id === originalId) || catalog.rads_plus.find(x => x.id === originalId) || titanRads.find(x => x.id === originalId) || steelRads.find(x => x.id === originalId));
        if (isRad) { if (this.state.radType === 'space') this.state.radType = 'plus'; else if (this.state.radType === 'plus') this.state.radType = 'titan'; else if (this.state.radType === 'titan') this.state.radType = 'steel'; else this.state.radType = 'space'; }
    ...
    getDesc: function (type, val1, val2, val3) {
        ...
        switch (type) {
            ...
            case 'rad_tooltip': {
                ...
                let isPlus = dev.id && dev.id.startsWith('rad_plus');

                let passPwr, pwrLine;
                if (isPlus) {
                    // Для PLUS: расчётная мощность 95 Вт/секц, номинал (ΔT=70) = 146.5 Вт/секц
                    let nominalPerSec = Math.round((dev.powerNominal || dev.sec * 146.5) / dev.sec * 10) / 10;
                    passPwr = dev.powerNominal || Math.round(dev.sec * 146.5);
                    pwrLine = `Секций: ${dev.sec}. Фактическая теплоотдача секции: <b style="color:var(--primary)">95 Вт (ΔT=50°C, расчёт)</b>`;
                } else if (isPanel) {
                    passPwr = dev.passportPower || Math.round(dev.power50 / 0.65) || 'undefined';
                ...
                return `<span style="font-size:12px; line-height:1.5; display:block; min-width:240px;">
                    ...
                    <span style="color:#9CA3AF; font-size:11px;">(Номинал: ${passPwr} Вт при ΔT=70°C)</span>
    ...
    render: function () {
        ...
        ['gas', 'el'].forEach(ft => {
            if (this.state.fuels.includes(ft)) {
                ...
                if (ft === 'el') {
                    ...
                    // Расчетная мощность с запасом 10%
                    let targetPower = parseFloat(pwr) * 1.1;
                    let haierBoiler;
                    if (!this.state.hotWater) {
                        // Бойлер ВЫКЛЮЧЕН → двухконтурный котёл (ГВС встроен)
                        haierBoiler = targetPower <= 18
                            ? catalog.boilers_gas.find(x => x.id === 'haier_2_18')
                            : catalog.boilers_gas.find(x => x.id === 'haier_2_24');
                    } else {
                        // Бойлер ВКЛЮЧЕН → одноконтурный котёл (ГВС через бойлер)
                        haierBoiler = targetPower <= 18
                            ? catalog.boilers_gas.find(x => x.id === 'haier_1_18')
                            : catalog.boilers_gas.find(x => x.id === 'haier_1_24');
                    }
                    if (haierBoiler) {
                        addToBill(haierBoiler, 1, this.getDesc('boiler_gas', parseFloat(pwr)));
                        selBoilers.push(haierBoiler);
                    }
                }
            }
        });
        ...
        if (hasRad) { let load = (hasTp && tpArea > 0) ? pwr * 1000 * 0.7 : pwr * 1000; radSecs = Math.ceil(load / 95); if (radSecs > 0) { let pipe = Math.ceil(this.state.win * (Math.sqrt(this.state.area / (this.state.floors === 2 ? 2 : 1)) + 3) * 1.1); radMeters = pipe * 2; } }
        ...
        if (hasRad && radSecs > 0) {
            ...
            if (this.state.detailedRooms && this.state.rooms && this.state.rooms.length > 0) {
                this.state.rooms.forEach(r => {
                    ...
                    r.windows.forEach((w, wIdx) => {
                        ...
                        if (w.isPan) {
                            ...
                            const P50_SPACE = 117, P50_PLUS = 95, P50_TITAN = 128;

                            // PLUS
                            let reqSecsPlus = Math.max(4, Math.ceil(reqPwr / P50_PLUS));
                            if ((reqSecsPlus * 0.08) < w.width * 0.7) reqSecsPlus = Math.max(reqSecsPlus, Math.ceil((w.width * 0.7) / 0.08));
                            let plusSecsOpts = [4, 6, 8, 10, 12];
                            let nearestPlus = plusSecsOpts.find(s => s >= reqSecsPlus) || 12;
                            let itemPlus = catalog.rads_plus.find(x => x.sec === nearestPlus) || catalog.rads_plus[catalog.rads_plus.length - 1];
                            ...
                            let altsList = [itemPlus, itemSpace, itemTitan, bestPanel];
                            itemPlus.alts = altsList; itemSpace.alts = altsList; itemTitan.alts = altsList; bestPanel.alts = altsList;
                            ...
                            } else if (this.state.radType === 'space') {
                                activeItem = itemSpace; factPower = itemSpace.sec * P50_SPACE;
                            } else {
                                // 'plus' — default
                                activeItem = itemPlus; factPower = itemPlus.sec * P50_PLUS;
                            }
                ...
                // PLUS
                let totalSecPlus = Math.ceil(heatLoadTotal / P50_PLUS);
                let countPlus = Math.max(win, Math.ceil(totalSecPlus / 12));
                let secPerRadPlus = Math.max(4, Math.min(12, Math.ceil(totalSecPlus / countPlus)));
                let plusSecsOpts = [4, 6, 8, 10, 12];
                let nearestPlusSec = plusSecsOpts.find(s => s >= secPerRadPlus) || 12;
                let itemPlus = catalog.rads_plus.find(x => x.sec === nearestPlusSec) || catalog.rads_plus[catalog.rads_plus.length - 1];
                ...
                if (this.state.radType === 'steel') {
                    ...
                    // 'plus' — default
                    activeItem = itemPlus; totalCount = countPlus; factPowerTotal = activeItem.sec * P50_PLUS * totalCount;
                }
