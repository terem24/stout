...
const getImg = (item) => {
    ...
    return `<img src="img/${item.id}.jpg" loading="lazy" class="prod-thumb" onerror="this.onerror=null;this.src='https://placehold.co/100x100/${bg}/555?text=${txt}&font=roboto';">`;
};
const workPrices = {
    boiler_gas: 20000,
    boiler_el: 18000,
