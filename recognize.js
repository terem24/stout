...
const RecognizeUI = {
    ...
    isAllowed() {
        ...
        // Распознавание — инструмент тарифа ПРОФИ, и одной отметки админа мало:
        // нужны оба условия. Доступ, выданный компании или региону, без тарифа
        // вкладку больше не открывает — иначе Базовый видел раздел, которым не
        // может пользоваться.
