...
const RecognizeMatch = (function () {
  ...
  const CATEGORIES = {
     ...
     *
     * water_pipes_mp — отрезной метраж, 175 ₽ за метр. metal_plastic_pipes —
     * полные бухты 100 и 200 м, 143 ₽ за метр. В подборе была подключена
     * только первая, и «Труба … бухта 200м — 800 м» уезжала в смету на
     * 25 600 ₽ дороже, чем та же труба бухтами, хотя бухты в каталоге есть.
     *
